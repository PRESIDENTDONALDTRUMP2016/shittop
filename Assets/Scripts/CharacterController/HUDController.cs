...
#region General Variables
    ...
    // ACTION TEXT - show/hide text collected by FindTarget.cs and the sprite button
    ...
    // DISPLAY CONTROLS - show the hud with the img controls	
	...
	// SHOW CHANGE INPUT TEXT - fadeIn text, show text during 'x' time then fadeOut	
    void InitFadeText(){
        if (fadeText != null){
